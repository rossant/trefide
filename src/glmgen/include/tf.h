...
double tf_obj(const double *x, const double *y, const double *w, 
              int n, int k, double lambda,
	      int family, double *beta, double *buf);
double tf_obj_gauss(const double *x, const double *y, const double *w, 
                    int n, int k, double lambda,
		    double *beta, double *buf);
double tf_obj_glm(const double *x, const double *y, const double *w, 
                  int n, int k, double lambda,
