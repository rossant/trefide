...
/* BEGIN: Cython Metadata
{
    "distutils": {
        "depends": [
            ...
            "trefide/solvers/src/line_search.c"
        ],
        "extra_compile_args": [
            "-O3"
        ],
        ...
        "name": "trefide.solvers.constrained",
        "sources": [
            "trefide/solvers/constrained.pyx",
            "trefide/solvers/src/utils.c",
            "trefide/solvers/src/wpdas.c"
        ]
    },
    "module_name": "trefide.solvers.constrained"
}
END: Cython Metadata */
...
#define __PYX_HAVE__trefide__solvers__constrained
#define __PYX_HAVE_API__trefide__solvers__constrained
#include <string.h>
#include <stdio.h>
#include "numpy/arrayobject.h"
#include "numpy/ufuncobject.h"
#include "src/line_search.c"
#include "pythread.h"
#include <stdlib.h>
#include "pystate.h"
#ifdef _OPENMP
...
struct __pyx_opt_args_7trefide_7solvers_11constrained_cpdas;

/* "trefide/solvers/constrained.pyx":31
...
/* Module declarations from 'trefide.solvers.constrained' */
...
static PyObject *__pyx_f_7trefide_7solvers_11constrained_cpdas(__Pyx_memviewslice const , double const , int __pyx_skip_dispatch, struct __pyx_opt_args_7trefide_7solvers_11constrained_cpdas *__pyx_optional_args); /*proto*/
...
#define __Pyx_MODULE_NAME "trefide.solvers.constrained"
extern int __pyx_module_is_main_trefide__solvers__constrained;
int __pyx_module_is_main_trefide__solvers__constrained = 0;

/* Implementation of 'trefide.solvers.constrained' */
...
static const char __pyx_k_step_part[] = "step_part";
static const char __pyx_k_IndexError[] = "IndexError";
static const char __pyx_k_ValueError[] = "ValueError";
static const char __pyx_k_max_interp[] = "max_interp";
...
static const char __pyx_k_PDAS_failed_to_converge_in_MAXIT[] = "PDAS failed to converge in MAXITER iterations.";
...
static PyObject *__pyx_kp_s_PDAS_failed_to_converge_in_MAXIT;
...
static PyObject *__pyx_n_s_max_interp;
...
static PyObject *__pyx_n_s_step_part;
...
static PyObject *__pyx_pf_7trefide_7solvers_11constrained_cpdas(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_y, double __pyx_v_delta, __Pyx_memviewslice __pyx_v_wi, __Pyx_memviewslice __pyx_v_z_hat, double __pyx_v_lambda_, int __pyx_v_step_part, int __pyx_v_max_interp, double __pyx_v_tol, int __pyx_v_verbose); /* proto */
...
static PyObject *__pyx_pw_7trefide_7solvers_11constrained_1cpdas(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static PyObject *__pyx_f_7trefide_7solvers_11constrained_cpdas(__Pyx_memviewslice const __pyx_v_y, double const __pyx_v_delta, CYTHON_UNUSED int __pyx_skip_dispatch, struct __pyx_opt_args_7trefide_7solvers_11constrained_cpdas *__pyx_optional_args) {
  __Pyx_memviewslice __pyx_v_wi = __pyx_k_;
  __Pyx_memviewslice __pyx_v_z_hat = __pyx_k__2;
  double __pyx_v_lambda_ = ((double)0.0);
  int __pyx_v_max_interp = ((int)1);
  double __pyx_v_tol = ((double)1e-3);
  int __pyx_v_verbose = ((int)0);
  __pyx_t_5numpy_intp_t __pyx_v_n;
  double __pyx_v_tau;
  double __pyx_v_int_width;
  ...
  __Pyx_RefNannySetupContext("cpdas", 0);
    ...
    if (__pyx_optional_args->__pyx_n > 0) {
      ...
      if (__pyx_optional_args->__pyx_n > 1) {
        ...
        if (__pyx_optional_args->__pyx_n > 2) {
          __pyx_v_lambda_ = __pyx_optional_args->lambda_;
          if (__pyx_optional_args->__pyx_n > 4) {
            __pyx_v_max_interp = __pyx_optional_args->max_interp;
  ...
  /* "trefide/solvers/constrained.pyx":45
 *     """
 * 
 ...
 */
  ...
  /* "trefide/solvers/constrained.pyx":46
 * 
 *     cdef np.intp_t n = y.shape[0]
 *     cdef double tau, int_width, delta_w, scale = 0             # <<<<<<<<<<<<<<
 *     cdef int i, iter_status, iters = 0
 ...
 */
  ...
  /* "trefide/solvers/constrained.pyx":47
 *     cdef np.intp_t n = y.shape[0]
 *     cdef double tau, int_width, delta_w, scale = 0
 *     cdef int i, iter_status, iters = 0             # <<<<<<<<<<<<<<
 *     cdef np.double_t[::1] x_hat = np.empty(n, dtype=np.double)
 ...
 */
  ...
  /* "trefide/solvers/constrained.pyx":48
 *     cdef double tau, int_width, delta_w, scale = 0
 *     cdef int i, iter_status, iters = 0
 *     cdef np.double_t[::1] x_hat = np.empty(n, dtype=np.double)             # <<<<<<<<<<<<<<
 * 
 ...
 */
  ...
  __pyx_t_1 = __Pyx_PyInt_From_Py_intptr_t(__pyx_v_n); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 48, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  ...
  /* "trefide/solvers/constrained.pyx":51
 * 
 *     # Default to unweighted l1tf
 *     if wi is None:             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_t_7) {
    ...
    /* "trefide/solvers/constrained.pyx":52
 *     # Default to unweighted l1tf
 *     if wi is None:
 *         wi = np.ones(n, dtype=np.double)             # <<<<<<<<<<<<<<
 *         delta_w = 1
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_5);
    __pyx_t_1 = __Pyx_PyObject_GetAttrStr(__pyx_t_5, __pyx_n_s_ones); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 52, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_1);
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    __pyx_t_5 = __Pyx_PyInt_From_Py_intptr_t(__pyx_v_n); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 52, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    ...
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_double); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 52, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    ...
    /* "trefide/solvers/constrained.pyx":53
 *     if wi is None:
 *         wi = np.ones(n, dtype=np.double)
 *         delta_w = 1             # <<<<<<<<<<<<<<
 *     else:
 ...
 */
  ...
  /* "trefide/solvers/constrained.pyx":55
 *         delta_w = 1
 *     else:
 *         delta_w = 0             # <<<<<<<<<<<<<<
 *         for i in range(n):
 ...
 */
  /*else*/ {
    ...
    /* "trefide/solvers/constrained.pyx":56
 *     else:
 *         delta_w = 0
 *         for i in range(n):             # <<<<<<<<<<<<<<
 *             delta_w += 1 / wi[i]
 ...
 */
    ...
    for (__pyx_t_10 = 0; __pyx_t_10 < __pyx_t_9; __pyx_t_10+=1) {
      ...
      /* "trefide/solvers/constrained.pyx":57
 *         delta_w = 0
 *         for i in range(n):
 *             delta_w += 1 / wi[i]             # <<<<<<<<<<<<<<
 *         delta_w /= n
 ...
 */
      ...
      __pyx_v_delta_w = (__pyx_v_delta_w + (1.0 / (*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_wi.data) + __pyx_t_11)) )))));
    }

    /* "trefide/solvers/constrained.pyx":58
 *         for i in range(n):
 *             delta_w += 1 / wi[i]
 *         delta_w /= n             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_v_delta_w = (__pyx_v_delta_w / __pyx_v_n);
  }
  __pyx_L3:;

  /* "trefide/solvers/constrained.pyx":61
 * 
 *     # Default to initializing dual var at 0
 *     if z_hat is None:             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_t_7) {
    ...
    /* "trefide/solvers/constrained.pyx":62
 *     # Default to initializing dual var at 0
 *     if z_hat is None:
 *         z_hat = np.zeros(n - 2, dtype=np.double)             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __pyx_t_4 = __Pyx_PyInt_From_long((__pyx_v_n - 2)); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 62, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_4);
 ...
 */
  ...
  /* "trefide/solvers/constrained.pyx":65
 * 
 *     # Initialize step size as target interval width / step_partition
 *     for i in range(n):             # <<<<<<<<<<<<<<
 ...
 */
  ...
  for (__pyx_t_10 = 0; __pyx_t_10 < __pyx_t_9; __pyx_t_10+=1) {
    ...
    /* "trefide/solvers/constrained.pyx":66
 *     # Initialize step size as target interval width / step_partition
 *     for i in range(n):
 *         scale += y[i] ** 2  # y assumed detrended or detrended             # <<<<<<<<<<<<<<
 *     scale /= n
 ...
 */
    ...
    __pyx_v_scale = (__pyx_v_scale + pow((*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_y.data) + __pyx_t_12)) ))), 2.0));
  }

  /* "trefide/solvers/constrained.pyx":67
 *     for i in range(n):
 *         scale += y[i] ** 2  # y assumed detrended or detrended
 *     scale /= n             # <<<<<<<<<<<<<<
 *     scale = delta / math.sqrt(scale - delta)
 ...
 */
  __pyx_v_scale = (__pyx_v_scale / __pyx_v_n);

  /* "trefide/solvers/constrained.pyx":68
 *         scale += y[i] ** 2  # y assumed detrended or detrended
 *     scale /= n
 *     scale = delta / math.sqrt(scale - delta)             # <<<<<<<<<<<<<<
 *     int_width = math.log(20+(1/scale)) - math.log(3+(1/scale))
 *     tau = int_width / 60
 */
  __pyx_t_2 = PyFloat_FromDouble(__pyx_v_delta); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 68, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_3 = __Pyx_GetModuleGlobalName(__pyx_n_s_math); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 68, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_sqrt); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 68, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = PyFloat_FromDouble((__pyx_v_scale - __pyx_v_delta)); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 68, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_1 = NULL;
  ...
  if (!__pyx_t_1) {
    __pyx_t_4 = __Pyx_PyObject_CallOneArg(__pyx_t_5, __pyx_t_3); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 68, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __Pyx_GOTREF(__pyx_t_4);
  } else {
    #if CYTHON_FAST_PYCALL
    ...
    #endif
    {
      __pyx_t_13 = PyTuple_New(1+1); if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 68, __pyx_L1_error)
      ...
      __pyx_t_3 = 0;
      __pyx_t_4 = __Pyx_PyObject_Call(__pyx_t_5, __pyx_t_13, NULL); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 68, __pyx_L1_error)
      __Pyx_GOTREF(__pyx_t_4);
      __Pyx_DECREF(__pyx_t_13); __pyx_t_13 = 0;
    }
  }
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_t_5 = __Pyx_PyNumber_Divide(__pyx_t_2, __pyx_t_4); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 68, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_14 = __pyx_PyFloat_AsDouble(__pyx_t_5); if (unlikely((__pyx_t_14 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 68, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __pyx_v_scale = __pyx_t_14;

  /* "trefide/solvers/constrained.pyx":69
 *     scale /= n
 *     scale = delta / math.sqrt(scale - delta)
 *     int_width = math.log(20+(1/scale)) - math.log(3+(1/scale))             # <<<<<<<<<<<<<<
 *     tau = int_width / 60
 * 
 */
  __pyx_t_4 = __Pyx_GetModuleGlobalName(__pyx_n_s_math); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 69, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_2 = __Pyx_PyObject_GetAttrStr(__pyx_t_4, __pyx_n_s_log); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 69, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_4 = PyFloat_FromDouble((20.0 + (1.0 / __pyx_v_scale))); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 69, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_13 = NULL;
  ...
  if (!__pyx_t_13) {
    __pyx_t_5 = __Pyx_PyObject_CallOneArg(__pyx_t_2, __pyx_t_4); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 69, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __Pyx_GOTREF(__pyx_t_5);
  } else {
    #if CYTHON_FAST_PYCALL
  ...
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_3 = __Pyx_GetModuleGlobalName(__pyx_n_s_math); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 69, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_4 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_log); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 69, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
  __pyx_t_3 = PyFloat_FromDouble((3.0 + (1.0 / __pyx_v_scale))); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 69, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_3);
  __pyx_t_13 = NULL;
  ...
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_t_4 = PyNumber_Subtract(__pyx_t_5, __pyx_t_2); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 69, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
  __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
  __pyx_t_14 = __pyx_PyFloat_AsDouble(__pyx_t_4); if (unlikely((__pyx_t_14 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 69, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
  __pyx_v_int_width = __pyx_t_14;

  /* "trefide/solvers/constrained.pyx":70
 *     scale = delta / math.sqrt(scale - delta)
 *     int_width = math.log(20+(1/scale)) - math.log(3+(1/scale))
 *     tau = int_width / 60             # <<<<<<<<<<<<<<
 * 
 ...
 */
  __pyx_v_tau = (__pyx_v_int_width / 60.0);

  /* "trefide/solvers/constrained.pyx":73
 * 
 *     # default to initializing lambda middle of target interval
 *     if lambda_ <= 0:             # <<<<<<<<<<<<<<
 ...
 * 
 */
  __pyx_t_7 = ((__pyx_v_lambda_ <= 0.0) != 0);
  if (__pyx_t_7) {

    /* "trefide/solvers/constrained.pyx":74
 *     # default to initializing lambda middle of target interval
 *     if lambda_ <= 0:
 *         lambda_ = math.exp(int_width / 2 + math.log(3*scale + 1)) - 1             # <<<<<<<<<<<<<<
 * 
 ...
 */
    ...
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_5 = __Pyx_PyObject_GetAttrStr(__pyx_t_2, __pyx_n_s_exp); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 74, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __pyx_t_2 = PyFloat_FromDouble((__pyx_v_int_width / 2.0)); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 74, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_3 = __Pyx_GetModuleGlobalName(__pyx_n_s_math); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 74, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_t_13 = __Pyx_PyObject_GetAttrStr(__pyx_t_3, __pyx_n_s_log); if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 74, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_13);
    __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
    __pyx_t_3 = PyFloat_FromDouble(((3.0 * __pyx_v_scale) + 1.0)); if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 74, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_3);
    __pyx_t_15 = NULL;
    ...
    if (!__pyx_t_15) {
      __pyx_t_1 = __Pyx_PyObject_CallOneArg(__pyx_t_13, __pyx_t_3); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 74, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
      __Pyx_GOTREF(__pyx_t_1);
    } else {
      #if CYTHON_FAST_PYCALL
      if (PyFunction_Check(__pyx_t_13)) {
        ...
        __pyx_t_1 = __Pyx_PyFunction_FastCall(__pyx_t_13, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 74, __pyx_L1_error)
      ...
      if (__Pyx_PyFastCFunction_Check(__pyx_t_13)) {
        PyObject *__pyx_temp[2] = {__pyx_t_15, __pyx_t_3};
        __pyx_t_1 = __Pyx_PyCFunction_FastCall(__pyx_t_13, __pyx_temp+1-1, 1+1); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 74, __pyx_L1_error)
        __Pyx_XDECREF(__pyx_t_15); __pyx_t_15 = 0;
        __Pyx_GOTREF(__pyx_t_1);
        __Pyx_DECREF(__pyx_t_3); __pyx_t_3 = 0;
      } else
      #endif
      {
        ...
        __pyx_t_3 = 0;
        __pyx_t_1 = __Pyx_PyObject_Call(__pyx_t_13, __pyx_t_16, NULL); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 74, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_1);
        __Pyx_DECREF(__pyx_t_16); __pyx_t_16 = 0;
      }
    }
    __Pyx_DECREF(__pyx_t_13); __pyx_t_13 = 0;
    __pyx_t_13 = PyNumber_Add(__pyx_t_2, __pyx_t_1); if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 74, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_13);
    __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
    __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;
    __pyx_t_1 = NULL;
    ...
    if (!__pyx_t_1) {
      __pyx_t_4 = __Pyx_PyObject_CallOneArg(__pyx_t_5, __pyx_t_13); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 74, __pyx_L1_error)
      __Pyx_DECREF(__pyx_t_13); __pyx_t_13 = 0;
      __Pyx_GOTREF(__pyx_t_4);
    } else {
      #if CYTHON_FAST_PYCALL
      ...
      #endif
      {
        ...
        __pyx_t_13 = 0;
        __pyx_t_4 = __Pyx_PyObject_Call(__pyx_t_5, __pyx_t_2, NULL); if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 74, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_4);
        __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
      }
    }
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    __pyx_t_5 = __Pyx_PyInt_SubtractObjC(__pyx_t_4, __pyx_int_1, 1, 0); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 74, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
    __Pyx_DECREF(__pyx_t_4); __pyx_t_4 = 0;
    __pyx_t_14 = __pyx_PyFloat_AsDouble(__pyx_t_5); if (unlikely((__pyx_t_14 == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 74, __pyx_L1_error)
    __Pyx_DECREF(__pyx_t_5); __pyx_t_5 = 0;
    __pyx_v_lambda_ = __pyx_t_14;
 ...
 */
  ...
  /* "trefide/solvers/constrained.pyx":77
 * 
 *     # Call Solver
 *     with nogil:             # <<<<<<<<<<<<<<
 ...
 */
  {
      ...
      /*try:*/ {
        ...
        /* "trefide/solvers/constrained.pyx":79
 *     with nogil:
 *         iter_status = call_line_search(n,
 * 				       &y[0],             # <<<<<<<<<<<<<<
 * 				       &wi[0],
 ...
 */
        ...
        /* "trefide/solvers/constrained.pyx":80
 *         iter_status = call_line_search(n,
 * 				       &y[0],
 * 				       &wi[0],             # <<<<<<<<<<<<<<
 * 				       delta*delta_w,
 ...
 */
        ...
        /* "trefide/solvers/constrained.pyx":83
 * 				       delta*delta_w,
 *                                        tau,
 * 				       &x_hat[0],             # <<<<<<<<<<<<<<
 * 				       &z_hat[0],
 ...
 */
        ...
        /* "trefide/solvers/constrained.pyx":84
 *                                        tau,
 * 				       &x_hat[0],
 * 				       &z_hat[0],             # <<<<<<<<<<<<<<
 * 				       &lambda_,
 ...
 */
        ...
        /* "trefide/solvers/constrained.pyx":78
 *     # Call Solver
 *     with nogil:
 *         iter_status = call_line_search(n,             # <<<<<<<<<<<<<<
 * 				       &y[0],
 * 				       &wi[0],
 */
        __pyx_v_iter_status = line_search(__pyx_v_n, (&(*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_y.data) + __pyx_t_17)) )))), (&(*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_wi.data) + __pyx_t_18)) )))), (__pyx_v_delta * __pyx_v_delta_w), __pyx_v_tau, (&(*((__pyx_t_5numpy_double_t *) ( /* dim=0 */ ((char *) (((__pyx_t_5numpy_double_t *) __pyx_v_x_hat.data) + __pyx_t_19)) )))), (&(*((double *) ( /* dim=0 */ ((char *) (((double *) __pyx_v_z_hat.data) + __pyx_t_20)) )))), (&__pyx_v_lambda_), (&__pyx_v_iters), __pyx_v_max_interp, __pyx_v_tol, __pyx_v_verbose);
      }
 ...
 */
  ...
  /* "trefide/solvers/constrained.pyx":92
 * 
 *     # Check Convergence
 *     if iter_status < 0:             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_t_7) {
    ...
    /* "trefide/solvers/constrained.pyx":93
 *     # Check Convergence
 *     if iter_status < 0:
 *         raise RuntimeError("PDAS failed to converge in MAXITER iterations.")             # <<<<<<<<<<<<<<
 * 
 ...
 */
    __pyx_t_5 = __Pyx_PyObject_Call(__pyx_builtin_RuntimeError, __pyx_tuple__3, NULL); if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 93, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_5);
 ...
 */
  ...
  /* "trefide/solvers/constrained.pyx":95
 *         raise RuntimeError("PDAS failed to converge in MAXITER iterations.")
 * 
 *     return x_hat, z_hat, lambda_, iters             # <<<<<<<<<<<<<<
 */
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_5 = __pyx_memoryview_fromslice(__pyx_v_x_hat, 1, (PyObject *(*)(char *)) __pyx_memview_get_nn___pyx_t_5numpy_double_t, (int (*)(char *, PyObject *)) __pyx_memview_set_nn___pyx_t_5numpy_double_t, 0);; if (unlikely(!__pyx_t_5)) __PYX_ERR(0, 95, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_5);
  __pyx_t_4 = __pyx_memoryview_fromslice(__pyx_v_z_hat, 1, (PyObject *(*)(char *)) __pyx_memview_get_double, (int (*)(char *, PyObject *)) __pyx_memview_set_double, 0);; if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 95, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_4);
  __pyx_t_2 = PyFloat_FromDouble(__pyx_v_lambda_); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 95, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_2);
  __pyx_t_13 = __Pyx_PyInt_From_int(__pyx_v_iters); if (unlikely(!__pyx_t_13)) __PYX_ERR(0, 95, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_13);
 ...
 */
  ...
  __Pyx_AddTraceback("trefide.solvers.constrained.cpdas", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __pyx_r = 0;
  __pyx_L0:;
...
/* Python wrapper */
static PyObject *__pyx_pw_7trefide_7solvers_11constrained_1cpdas(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_7trefide_7solvers_11constrained_cpdas[] = " \n    Conduct line search in lambda space to solve constrianed problem \n    via lagrangian pdas solver\n    ";
static PyObject *__pyx_pw_7trefide_7solvers_11constrained_1cpdas(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  int __pyx_v_step_part;
  int __pyx_v_max_interp;
  double __pyx_v_tol;
  int __pyx_v_verbose;
  PyObject *__pyx_r = 0;
  __Pyx_RefNannyDeclarations
  __Pyx_RefNannySetupContext("cpdas (wrapper)", 0);
  {
    static PyObject **__pyx_pyargnames[] = {&__pyx_n_s_y,&__pyx_n_s_delta,&__pyx_n_s_wi,&__pyx_n_s_z_hat,&__pyx_n_s_lambda,&__pyx_n_s_step_part,&__pyx_n_s_max_interp,&__pyx_n_s_tol,&__pyx_n_s_verbose,0};
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        if (likely((values[1] = PyDict_GetItem(__pyx_kwds, __pyx_n_s_delta)) != 0)) kw_args--;
          ...
          __Pyx_RaiseArgtupleInvalid("cpdas", 0, 2, 9, 1); __PYX_ERR(0, 31, __pyx_L3_error)
        }
        CYTHON_FALLTHROUGH;
        case  2:
        if (kw_args > 0) {
        ...
        case  5:
        if (kw_args > 0) {
          PyObject* value = PyDict_GetItem(__pyx_kwds, __pyx_n_s_step_part);
          if (value) { values[5] = value; kw_args--; }
        }
        CYTHON_FALLTHROUGH;
        case  6:
        if (kw_args > 0) {
          PyObject* value = PyDict_GetItem(__pyx_kwds, __pyx_n_s_max_interp);
      ...
      if (unlikely(kw_args > 0)) {
        if (unlikely(__Pyx_ParseOptionalKeywords(__pyx_kwds, __pyx_pyargnames, 0, values, pos_args, "cpdas") < 0)) __PYX_ERR(0, 31, __pyx_L3_error)
      }
    } else {
    ...
    __pyx_v_y = __Pyx_PyObject_to_MemoryviewSlice_dc_double(values[0]); if (unlikely(!__pyx_v_y.memview)) __PYX_ERR(0, 31, __pyx_L3_error)
    __pyx_v_delta = __pyx_PyFloat_AsDouble(values[1]); if (unlikely((__pyx_v_delta == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 32, __pyx_L3_error)
    if (values[2]) {
      __pyx_v_wi = __Pyx_PyObject_to_MemoryviewSlice_dc_double(values[2]); if (unlikely(!__pyx_v_wi.memview)) __PYX_ERR(0, 33, __pyx_L3_error)
    } else {
      __pyx_v_wi = __pyx_k_;
      __PYX_INC_MEMVIEW(&__pyx_v_wi, 1);
    }
    if (values[3]) {
      __pyx_v_z_hat = __Pyx_PyObject_to_MemoryviewSlice_dc_double(values[3]); if (unlikely(!__pyx_v_z_hat.memview)) __PYX_ERR(0, 34, __pyx_L3_error)
    } else {
      __pyx_v_z_hat = __pyx_k__2;
      __PYX_INC_MEMVIEW(&__pyx_v_z_hat, 1);
    }
    if (values[4]) {
      __pyx_v_lambda_ = __pyx_PyFloat_AsDouble(values[4]); if (unlikely((__pyx_v_lambda_ == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 35, __pyx_L3_error)
    } else {
      __pyx_v_lambda_ = ((double)0.0);
    }
    if (values[5]) {
      __pyx_v_step_part = __Pyx_PyInt_As_int(values[5]); if (unlikely((__pyx_v_step_part == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 36, __pyx_L3_error)
    } else {
      __pyx_v_step_part = ((int)60);
    }
    if (values[6]) {
      __pyx_v_max_interp = __Pyx_PyInt_As_int(values[6]); if (unlikely((__pyx_v_max_interp == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 37, __pyx_L3_error)
    } else {
      __pyx_v_max_interp = ((int)1);
    }
    if (values[7]) {
      __pyx_v_tol = __pyx_PyFloat_AsDouble(values[7]); if (unlikely((__pyx_v_tol == (double)-1) && PyErr_Occurred())) __PYX_ERR(0, 38, __pyx_L3_error)
    } else {
      __pyx_v_tol = ((double)1e-3);
    }
    if (values[8]) {
      __pyx_v_verbose = __Pyx_PyInt_As_int(values[8]); if (unlikely((__pyx_v_verbose == (int)-1) && PyErr_Occurred())) __PYX_ERR(0, 39, __pyx_L3_error)
    } else {
  ...
  __Pyx_RaiseArgtupleInvalid("cpdas", 0, 2, 9, PyTuple_GET_SIZE(__pyx_args)); __PYX_ERR(0, 31, __pyx_L3_error)
  __pyx_L3_error:;
  __Pyx_AddTraceback("trefide.solvers.constrained.cpdas", __pyx_clineno, __pyx_lineno, __pyx_filename);
  __Pyx_RefNannyFinishContext();
  return NULL;
  __pyx_L4_argument_unpacking_done:;
  __pyx_r = __pyx_pf_7trefide_7solvers_11constrained_cpdas(__pyx_self, __pyx_v_y, __pyx_v_delta, __pyx_v_wi, __pyx_v_z_hat, __pyx_v_lambda_, __pyx_v_step_part, __pyx_v_max_interp, __pyx_v_tol, __pyx_v_verbose);
...
static PyObject *__pyx_pf_7trefide_7solvers_11constrained_cpdas(CYTHON_UNUSED PyObject *__pyx_self, __Pyx_memviewslice __pyx_v_y, double __pyx_v_delta, __Pyx_memviewslice __pyx_v_wi, __Pyx_memviewslice __pyx_v_z_hat, double __pyx_v_lambda_, int __pyx_v_step_part, int __pyx_v_max_interp, double __pyx_v_tol, int __pyx_v_verbose) {
  PyObject *__pyx_r = NULL;
  __Pyx_RefNannyDeclarations
  PyObject *__pyx_t_1 = NULL;
  struct __pyx_opt_args_7trefide_7solvers_11constrained_cpdas __pyx_t_2;
  __Pyx_RefNannySetupContext("cpdas", 0);
  __Pyx_XDECREF(__pyx_r);
  __pyx_t_2.__pyx_n = 7;
  __pyx_t_2.wi = __pyx_v_wi;
  __pyx_t_2.z_hat = __pyx_v_z_hat;
  __pyx_t_2.lambda_ = __pyx_v_lambda_;
  __pyx_t_2.step_part = __pyx_v_step_part;
  __pyx_t_2.max_interp = __pyx_v_max_interp;
  __pyx_t_2.tol = __pyx_v_tol;
  __pyx_t_2.verbose = __pyx_v_verbose;
  __pyx_t_1 = __pyx_f_7trefide_7solvers_11constrained_cpdas(__pyx_v_y, __pyx_v_delta, 0, &__pyx_t_2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 31, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  __pyx_r = __pyx_t_1;
  __pyx_t_1 = 0;
  goto __pyx_L0;
 ...
 */
      /*else*/ {
        __pyx_t_9 = __Pyx_PyList_Append(__pyx_v_result, __pyx_slice__27); if (unlikely(__pyx_t_9 == ((int)-1))) __PYX_ERR(2, 673, __pyx_L1_error)
      }
      __pyx_L7:;
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "trefide.solvers.constrained.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "trefide.solvers.constrained.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "trefide.solvers.constrained.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "trefide.solvers.constrained._memoryviewslice", /*tp_name*/
...
static PyMethodDef __pyx_methods[] = {
  {"cpdas", (PyCFunction)__pyx_pw_7trefide_7solvers_11constrained_1cpdas, METH_VARARGS|METH_KEYWORDS, __pyx_doc_7trefide_7solvers_11constrained_cpdas},
  {0, 0, 0, 0}
};
...
static int __pyx_pymod_exec_constrained(PyObject* module); /*proto*/
static PyModuleDef_Slot __pyx_moduledef_slots[] = {
  {Py_mod_create, (void*)__pyx_pymod_create},
  {Py_mod_exec, (void*)__pyx_pymod_exec_constrained},
  {0, NULL}
};
#endif
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_s_PDAS_failed_to_converge_in_MAXIT, __pyx_k_PDAS_failed_to_converge_in_MAXIT, sizeof(__pyx_k_PDAS_failed_to_converge_in_MAXIT), 0, 0, 1, 0},
  ...
  {&__pyx_n_s_max_interp, __pyx_k_max_interp, sizeof(__pyx_k_max_interp), 0, 0, 1, 1},
  ...
  {&__pyx_n_s_step_part, __pyx_k_step_part, sizeof(__pyx_k_step_part), 0, 0, 1, 1},
 ...
 *     return x_hat, z_hat, lambda_, iters
 */
  __pyx_tuple__3 = PyTuple_Pack(1, __pyx_kp_s_PDAS_failed_to_converge_in_MAXIT); if (unlikely(!__pyx_tuple__3)) __PYX_ERR(0, 93, __pyx_L1_error)
...
#if PY_MAJOR_VERSION < 3
PyMODINIT_FUNC initconstrained(void); /*proto*/
PyMODINIT_FUNC initconstrained(void)
#else
PyMODINIT_FUNC PyInit_constrained(void); /*proto*/
PyMODINIT_FUNC PyInit_constrained(void)
#if CYTHON_PEP489_MULTI_PHASE_INIT
{
...
static int __pyx_pymod_exec_constrained(PyObject *__pyx_pyinit_module)
#endif
#endif
{
  PyObject *__pyx_t_1 = NULL;
  ...
  #endif
  __Pyx_RefNannySetupContext("PyMODINIT_FUNC PyInit_constrained(void)", 0);
  ...
  #else
  #if PY_MAJOR_VERSION < 3
  __pyx_m = Py_InitModule4("constrained", __pyx_methods, 0, 0, PYTHON_API_VERSION); Py_XINCREF(__pyx_m);
  #else
  ...
  #endif
  if (__pyx_module_is_main_trefide__solvers__constrained) {
    if (PyObject_SetAttrString(__pyx_m, "__name__", __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "trefide.solvers.constrained")) {
      if (unlikely(PyDict_SetItemString(modules, "trefide.solvers.constrained", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "trefide/solvers/constrained.pyx":7
 ...
 */
  ...
  /* "trefide/solvers/constrained.pyx":8
 * 
 * import math
 * import numpy as np             # <<<<<<<<<<<<<<
 * cimport numpy as np
 ...
 */
  ...
  /* "trefide/solvers/constrained.pyx":14
 ...
 */
  ...
  /* "trefide/solvers/constrained.pyx":33
 * cpdef cpdas(const double[::1] y,    # Observations
 *         const double delta,         # MSE constraint
 *         double[::1] wi=None,        # Observation weights             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (unlikely(!__pyx_t_3.memview)) __PYX_ERR(0, 33, __pyx_L1_error)
  __pyx_k_ = __pyx_t_3;
  __pyx_t_3.memview = NULL;
  __pyx_t_3.data = NULL;

  /* "trefide/solvers/constrained.pyx":34
 *         const double delta,         # MSE constraint
 *         double[::1] wi=None,        # Observation weights
 *         double[::1] z_hat=None,     # Dual variable warm start             # <<<<<<<<<<<<<<
 *         double lambda_=0,           # Lagrange multiplier warm start
 ...
 */
  ...
  /* "trefide/solvers/constrained.pyx":1
 * # cython: cdivision=True             # <<<<<<<<<<<<<<
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init trefide.solvers.constrained", 0, __pyx_lineno, __pyx_filename);
    }
    Py_DECREF(__pyx_m); __pyx_m = 0;
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init trefide.solvers.constrained");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
